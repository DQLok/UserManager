...
public class FilterDispatcher implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try{
            ...
            // get attribute in context scope
            ServletContext context=req.getServletContext();
            Map<String,String> propertymap=(Map<String, String>)context.getAttribute("PROPERTY_MAP");
            //forward servlet
            String url=propertymap.get(resource);
